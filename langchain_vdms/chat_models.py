...
class ChatVdms(BaseChatModel):
    ...
    """Vdms chat model integration.

    The default implementation echoes the first `parrot_buffer_length` characters of the input.

    # TODO: Replace with relevant packages, env vars.
    Setup:
        Install ``langchain-vdms`` and set environment variable ``VDMS_API_KEY``.

        .. code-block:: bash

            pip install -U langchain-vdms
            export VDMS_API_KEY="your-api-key"

    # TODO: Populate with relevant params.
    Key init args — completion params:
        model: str
            Name of Vdms model to use.
        temperature: float
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            Vdms API key. If not passed in will be read from env var VDMS_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatVdms.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatVdms.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatVdms supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatVdms supports async generation. Otherwise delete.
